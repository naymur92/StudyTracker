...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('study')->name('api.study.')->group(function () {
        ...
        Route::post('/topics', [TopicApiController::class, 'store'])->middleware('throttle:study-write')->name('topics.store');
        Route::get('/topics/{topic}', [TopicApiController::class, 'show'])->middleware('throttle:study-read')->name('topics.show');
        Route::match(['put', 'patch'], '/topics/{topic}', [TopicApiController::class, 'update'])->middleware('throttle:study-write')->name('topics.update');
        Route::delete('/topics/{topic}', [TopicApiController::class, 'destroy'])->middleware('throttle:study-write')->name('topics.destroy');

        // Practice Logs
        Route::get('/practice-logs', [PracticeLogApiController::class, 'index'])->middleware('throttle:study-read')->name('practice-logs.index');
        Route::post('/practice-logs', [PracticeLogApiController::class, 'store'])->middleware('throttle:study-write')->name('practice-logs.store');
        Route::match(['put', 'patch'], '/practice-logs/{practiceLog}', [PracticeLogApiController::class, 'update'])->middleware('throttle:study-write')->name('practice-logs.update');
        Route::delete('/practice-logs/{practiceLog}', [PracticeLogApiController::class, 'destroy'])->middleware('throttle:study-write')->name('practice-logs.destroy');

        // Categories
        Route::get('/categories', [CategoryApiController::class, 'index'])->middleware('throttle:study-read')->name('categories.index');
        Route::post('/categories', [CategoryApiController::class, 'store'])->middleware('throttle:study-write')->name('categories.store');
        Route::match(['put', 'patch'], '/categories/{category}', [CategoryApiController::class, 'update'])->middleware('throttle:study-write')->name('categories.update');
        Route::delete('/categories/{category}', [CategoryApiController::class, 'destroy'])->middleware('throttle:study-write')->name('categories.destroy');
        ...
        Route::put('/revision-templates', [RevisionTemplateApiController::class, 'update'])->middleware('throttle:study-write')->name('revision-templates.update');
        Route::post('/revision-templates/reset', [RevisionTemplateApiController::class, 'reset'])->middleware('throttle:study-write')->name('revision-templates.reset');
    });
});
